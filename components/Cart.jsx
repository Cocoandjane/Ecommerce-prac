      ...
      <div className='cart-container'>
        ...
        {cartItems.length < 1 && (
          <div className='empty-cart'>
            ...
            <h3>Your shopping bat is empty</h3>
            <Link href="/">
        ...
        <div className='product-container'>
          {cartItems.length >= 1 && cartItems.sort((a, b) => new Date(a.date) - new Date(b.date)).map((item) => (
            <div className='product' key={item?._id}>
              ...
              <div className='item-desc'>
                ...
                <div className='flex bottom'>
                  ...
                  <button type='button' className='remove-item' onClick={() => removeCartItem(item)}>
                    <TiDeleteOutline />
                  </button>
